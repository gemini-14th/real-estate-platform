...
const PROPERTIES = [
    {
        ...
        sqft: 6500,
        type: "Sale",
        tags: ["Luxury", "Pool", "View", "Garden"].join(","),
    ...
    },
    {
        ...
        sqft: 1200,
        type: "Rent",
        tags: ["City", "Modern", "Security"].join(","),
        agentName: "Mike Ross",
        agentAvatar: "https://i.pravatar.cc/150?u=mike"
    },
    {
        ...
        sqft: 2800,
        type: "Sale",
        tags: ["Beach", "Holiday", "View"].join(","),
        agentName: "Emily Blunt",
        agentAvatar: "https://i.pravatar.cc/150?u=emily"
    },
    {
        ...
        sqft: 2000,
        type: "Rent",
        tags: ["Furnished", "Gym", "Pool"].join(","),
        agentName: "John Kamau",
        agentAvatar: "https://i.pravatar.cc/150?u=john"
    },
    {
        ...
        sqft: 8000,
        type: "Sale",
        tags: ["Gated Community", "Garden", "Ambassadorial"].join(","),
        agentName: "Alice Wanjiku",
        agentAvatar: "https://i.pravatar.cc/150?u=alice"
    }
];
...
async function main() {
    ...
    for (const property of PROPERTIES) {
        ...
        console.log(`Created property with id: ${p.id}`);
    }
